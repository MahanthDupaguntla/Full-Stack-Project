...
export const INITIAL_ARTWORKS: Artwork[] = [
  {
    ...
    bids: [{ id: 'b1', artworkId: '1', bidderName: 'John Doe', amount: 4200, timestamp: Date.now() - 50000 }]
  },
  {
    id: '2',
  ...
  },
  {
    ...
    year: 2023,
    imageUrl: 'https://images.unsplash.com/photo-1501472312651-726afe119ff1?auto=format&fit=crop&q=80&w=1000',
    price: 2100,
    category: 'Minimalism',
  },
  {
    ...
    artist: 'David Chen',
    description: 'A study of movement in stillness, representing the urban flow through long-exposure painting techniques.',
    year: 2024,
    imageUrl: 'https://images.unsplash.com/photo-1515405290399-ed34273bb427?auto=format&fit=crop&q=80&w=1000',
    price: 5600,
    category: 'Abstract',
    isAuction: true,
    currentBid: 5100,
...
export const INITIAL_EXHIBITIONS: Exhibition[] = [
  ...
  },
  {
    ...
    curatorId: 'cur-1',
    artworkIds: ['2', '4', '7'],
    bannerUrl: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?auto=format&fit=crop&q=80&w=1200',
  ...
  },
  {
    ...
    curatorId: 'cur-2',
    artworkIds: ['5', '8'],
    bannerUrl: 'https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?auto=format&fit=crop&q=80&w=1200',
